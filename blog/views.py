...
info = {
    ...
    "blog": blog_dataset  # Добавим в контекст шаблона информацию о новостях, чтобы все было в одном месте
}
...
def get_detail_article_by_id(request, article_id):
    ...
    for a in blog_dataset:
        ...
        if article:
            return render(request, 'blog/article_detail.html', context=info)
